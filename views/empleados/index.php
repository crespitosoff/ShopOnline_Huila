            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions">
                                <a href="form.php?id=<?= $e['id_empleado'] ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="../../controllers/Empleados/EliminarEmpleadoController.php?id=<?= $e['id_empleado'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este registro?')">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
