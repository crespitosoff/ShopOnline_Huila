    ...
    <div class="topbar">
        <div class="topbar-inner">
            ...
            <nav class="topbar-nav">
                <a href="../../views/clientes/index.php" class="active">Clientes</a>
                        ...
                        <?php else: ?>
                            <?php foreach ($clientes as $c): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="form.php?id=<?= $c['id_cliente'] ?>"
                                                class="btn btn-warning btn-sm">Editar</a>
                                            <a href="../../controllers/Clientes/EliminarClienteController.php?id=<?= $c['id_cliente'] ?>"
